...
export const Admission = ({
    ...
    const previewText = `${studentName} নতুন নিবন্ধন সম্পন্ন করেছেন`
            ...
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Section style={notificationBanner}>
                        <Heading style={notificationTitle}>নতুন নিবন্ধন সম্পন্ন করেছেন</Heading>
                    </Section>

                    {/* Registration Info */}
                    <Section style={infoSection}>
                        <Text style={infoText}>
                            একজন নতুন শিক্ষার্থী আমাদের কোর্সে ভর্তির জন্য নিবন্ধন করেছেন। নিচে তার বিস্তারিত তথ্য দেওয়া হলো:
                        </Text>
                    </Section>
