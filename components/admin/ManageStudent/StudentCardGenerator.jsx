        ...
        <div className="space-y-6">
            <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                    ...
                    <p className="text-base text-gray-500">Download professional student identification cards</p>
                </div>
            </div>
                        ...
                        <div ref={frontRef} className="bg-white w-[348px] h-[552.71px] mx-auto p-0 m-0">
                            <div className="w-full h-full bg-white border-gray-100 overflow-hidden p-0 m-0">
                                ...
                                <div className="px-6 py-4 text-center">
                                    ...
                                    <h2 className="text-2xl font-bold text-gray-800 mt-1 mb-1">
                                        {student.studentName}
                                    </h2>
                                ...
                                <div className="px-6 pb-6 space-y-3">
                                    <div className="bg-[#00558C]/7 rounded-xl p-4 space-y-3">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div className="flex gap-8">
                                                ...
                                                <p className="text-bse font-semibold text-gray-800">
                                                    {student.batchNumber}
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    {/* ID Number */}
                                    <div className="bg-[#00558C] rounded-xl p-4 text-center mt-4">
                                        <p className="text-blue-100 text-base font-medium uppercase tracking-wider">
                                            Student ID Number
                                        </p>
