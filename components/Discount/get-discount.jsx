...
export function GetDiscount({ triggerElements }) {
    ...
    async function onSubmit(data) {
        ...
        try {
            // Simulate API call
            const sendEmail = await axios.post("/api/mail/discount", data);
            ...
            <DialogContent className="w-full max-w-[800px] max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogTitle className="text-2xl font-bold text-primary-700">
                        অফারটি সম্পর্কে জানতে নিম্নে প্রদত্ত ফর্মটি এখনই পূরণ করুন,
                        আমাদের প্রতিনিধি শীঘ্রই আপনার সাথে যোগাযোগ করবেঃ
                    </DialogTitle>
                    <DialogDescription className="text-center">
                        * অফারটি নির্দিষ্ট সময়ের জন্যই প্রযোজ্য থাকছে।
                    </DialogDescription>
                </DialogHeader>
